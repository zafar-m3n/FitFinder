            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6 flex justify-between">
                        <h3 class="text-xl font-semibold">Promotions List</h3>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @foreach ($promotions as $promotion)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <div class="text-sm text-gray-900">{{ $promotion->discount }}%</div>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <div class="text-sm text-gray-900">{{ $promotion->start_date }}</div>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <div class="text-sm text-gray-900">{{ $promotion->end_date }}</div>
                                        </td>
