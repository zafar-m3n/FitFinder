        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="mb-6 text-2xl font-semibold">Welcome back, {{ Auth::user()->name }}!</h3>
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-2 text-gray-500">Check your recent orders</p>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <a href="#"
                        ...
                        <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold text-gray-700">Browse Products</h3>
                                        <p class="mt-2 text-gray-500">Explore our product range</p>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <a href="#"
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-2 text-gray-500">Get help with your orders</p>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <a href="#"
                                        class="rounded bg-yellow-500 px-4 py-2 text-white hover:bg-yellow-600">Get
                                        Support</a>
                                </div>
                            </div>
                        </div>
